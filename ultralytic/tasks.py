...
from ultralytics.nn.modules.attention.RMiT import DRAMiTransformer
from ultralytics.nn.modules.attention.hstofomer import HistogramTransformerBlock
...
DETECT_CLASS = (Detect, Detect_DyHead, Detect_AFPN_P2345, Detect_AFPN_P2345_Custom, Detect_AFPN_P345, Detect_AFPN_P345_Custom, Detect_Efficient, DetectAux, Detect_SEAM, Detect_MultiSEAM, 
                Detect_DyHeadWithDCNV3, Detect_DyHeadWithDCNV4, Detect_DyHead_Prune, Detect_LSCD,  Detect_LADH, Detect_LSCSBD, Detect_LSDECD)
V10_DETECT_CLASS = (v10Detect,v10Detect_LSCD_LQE, Detect_NMSFree, v10Detect_LSCD, v10Detect_SEAM, v10Detect_MultiSEAM)
...
from ultralytics.nn.modules.attention.PPA import PPA
class BaseModel(nn.Module):
    ...
    def _apply(self, fn):
        ...
        if isinstance(m, (Detect,DETECT_CLASS)):  # includes all Detect subclasses like Segment, Pose, OBB, WorldDetect
    ...
    def loss(self, batch, preds=None, epoch=0):
        ...
        sss=self.criterion(preds, batch,epoch=epoch )
        return sss 
...
def parse_model(d, ch, verbose=True):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d["backbone"] + d["head"]):  # from, number, module, args
        ...
        if m in {
            ...
            C2f_DCMB,C2f_DCMB_KAN,
            PPA,StarBlock,CSP_MutilScaleEdgeInformationEnhance,DRFD,C2f_iRMB_Cascaded,PinwheelConv,C2f_StripCGLU,C2f_AP
            ...
            if m in {
                ...
                C3TR, C3Ghost, C3x,RepC3,C2fPSA,C2fCIB,C2PSA,StarBlock
                ,CSP_MutilScaleEdgeInformationEnhance,C2f_iRMB_Cascaded,C2f_AP,C2f_StripCGLU,C2f_DCMB
                ,C2f_DCMB_KAN
            }:
            ...
            args = [ch[f], *args]
        elif m in (HGStem, HGBlock, Ghost_HGBlock, Rep_HGBlock,EIEStemdsm_mutiv2,EIEStemdsm_mutiv3,Dynamic_HGBlock, EIEStem,PiEIEStem):
            ...
            if m in (Detect_LSCD, Detect_TADDH, Detect_LSCSBD, Detect_LSDECD, v10Detect_LSCD_LQE,v10Detect_LSCD):
