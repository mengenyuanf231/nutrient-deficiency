...
def bbox_iou(box1, box2, xywh=True, GIoU=False, DIoU=False, CIoU=False,Inner=False,Focaliou=False,PIoU=False, d=0.00,u=0.95,ratio=0.7,eps=1e-7,scale=0.0):
    """
    ...
    # Union Area
        union = w1_ * h1 * ratio * ratio + w2_ * h2 * ratio * ratio - inter + eps
